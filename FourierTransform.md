...
## 3.5 <mark>Method 1</mark>: Calculation of the period by fitting peak frequencies vs harmonics
...
## 3.6 <mark>Method 2</mark>: Calculation of the period by measuring distances between peaks
